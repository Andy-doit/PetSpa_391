...
import { BiCalendarEdit, BiSolidBookBookmark } from "react-icons/bi";
...
export const QuantityAllBooking = () => {
    ...
    return (
        <Card className="xl:max-w-sm bg-red-500 rounded-xl shadow-md px-2 w-full h-fit">
            <CardBody className="py-5 overflow-hidden">
                <div className="flex gap-2.5">
                    <MdBookmark color="white" className="w-10 h-10" />
